    ...
    <section name="skills" className="w-full pt-12 md:pt-16">
      <div className="max-w-[900px] mx-auto p-4 md:p-8">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 text-center gap-5 py-10">
          ...
          <div className="shadow-md shadow-[rgba(19,33,50,0.8)] p-5 hover:scale-[1.2] duration-500 select-none">
            <FaNodeJs className="text-[#8BBF3D] mx-auto mb-4 text-4xl md:text-6xl" />
            <span className="mt-4 text-sm md:text-base">NodeJs</span>
          </div>
          <div className="shadow-md shadow-[rgba(19,33,50,0.8)] p-5 hover:scale-[1.2] duration-500 select-none">
            <SiExpress className="text-[#EEEEEE] mx-auto mb-4 text-4xl md:text-6xl" />
            <span className="mt-4 text-sm md:text-base">Express</span>
          </div>
          <div className="shadow-md shadow-[rgba(19,33,50,0.8)] p-5 hover:scale-[1.2] duration-500 select-none">
            <SiMongodb className="text-[#0FA54D] mx-auto mb-4 text-4xl md:text-6xl" />
            <span className="mt-4 text-sm md:text-base">MongoDB</span>
          </div>
          <div
            className={`${
              active ? 'block' : 'hidden'
          ...
          >
            <FaSass className="scale-[1.4] text-[#C66394] mx-auto mb-4 text-4xl md:text-6xl" />
            <span className="mt-4 text-sm md:text-base">Sass</span>
          </div>
          <div
            className={`${
              active ? 'block' : 'hidden'
