  ...
  return (
    <section className="w-full flex flex-col pt-14 md:pt-16" name="about">
      ...
      <div className="w-full max-w-[900px] flex flex-col justify-center mx-auto px-8">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between my-5 md:my-7">
          <div className="mt-8">
            ...
            <p className="text-base md:text-lg">
              I create beautiful, responsive and efficient websites and web
              aplications your users will love
            </p>
          </div>
        ...
        <p className="text-base md:text-lg">
          I'm a self-taught front-end developer with an array of amazing
          projects. I dedicate myself to develop websites and web aplications
          that are objective, functional and attractive in their look. Always
          based on the principles of usability and navigability.
        </p>
