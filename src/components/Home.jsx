...
const Home = () => {
  ...
  return (
    <section
      className='w-full flex justify-center align-center flex-col pt-16 md:pt-20 h-screen'
      name='about'>
      <div className='w-full max-w-[900px] flex flex-col justify-center mx-auto px-4 md:px-8'>
        <div className='flex flex-col md:flex-row-reverse align-center justify-center'>
          {/* Profile Picture */}
          <div
            className='w-60 h-60 md:w-80 md:h-80 border-2 md:border-[3px] animate-morph border-theme-white flex justify-center items-center m-auto md:ml-auto md:my-auto transition-all duration-[1s] bg-center bg-no-repeat bg-cover border-3 border-solid relative ease-in-out'
            style={pictureStyle}></div>
          <div>
            {/* Introduction */}
            <div className='flex flex-col md:flex-row items-start justify-between mb-6'>
              <div className='mt-12 md:mt-6 mx-auto md:mx-0'>
