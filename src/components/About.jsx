      ...
      <div className='w-full max-w-[900px] flex flex-col justify-center mx-auto px-4 md:px-8'>
        <div className='flex flex-col md:flex-row items-start justify-between mb-6'>
          ...
          <div className='md:mt-6 mx-auto md:mx-0'>
            ...
            <h2 className='text-base sm:text-lg mb-3'>{i18n.t('aboutSection.welcome')}</h2>
          ...
          <div className='w-40 h-40 md:min-w-[180px] md:min-h-[180px] rounded-full border-2 md:border-[3px] border-theme-white flex justify-center items-center mt-6 md:ml-10 mx-auto md:mx-0'>
            <img
              ...
              className='block w-36 h-36 hover:scale-105 active:scale-105 md:min-w-[160px] md:min-h-[160px] rounded-full border border-solid border-black duration-300 select-none'></img>
          </div>
        </div>
        ...
        {/* Description */}
        <p className='text-base sm:text-lg 2xl:text-xl'>{i18n.t('aboutSection.description')}</p>
